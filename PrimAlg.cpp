...
/*
Aþaðýdaki matrisi kopyalayýp matris.txt dosyasýna kaydedin. Bu bizim kullanacaðýmýz veri yapýsý olacak
Unutmayýn, kodunuzla ayný klasörde olmalý.
0 2 0 6 0
2 0 3 8 5
0 3 0 0 7
6 8 0 0 9
...
void prims(int Array[5][5])
{
    ...
    for(j = 0; j < 5; j++)
    {
        ...
        for(t = 0; t < 5; t++)
        {
            //Asgari tarama aðacýna en az maliyete sahip 
			//ziyaret edilmemiþ düðümü ekliyoruz. Ancak Parent'ý tutmayý unutmuyoruz.
